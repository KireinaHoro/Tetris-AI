...
public class TLabel {
  ...
  public void line(double x0, double y0, double x1, double y1) {
    //		System.out.println("drawing a line from " + new Point(x0, y0).toString()+ " to " + new
    // Point(x1,y1).toString());
  ...
  public void rectangle(
      double x, double y, double w, double h, Color c, boolean Border, Color BorderColor) {
